...
export default authMiddleware({
  publicRoutes: ['/', '/api/create-chat','/api/get-feedback','/shared-chat/:sharedLink', '/feedbacks','/api/testme','/api/chat','/api/stripe','/api/get-messages'], // Add '/api/create-chat' to public routes if you don't want auth here
